...
For a Custom JWT based authentication outside the services mention above you need to use the [`Web3Auth Plug and Play Core SDK`](../core) since the
Web3Auth Modal will not contain those custom logins you're looking for.
