...
import CustomAuthenticationCoreExample from "../references/_custom-authentication-core-example.mdx";
...
import Web3AuthCoreOptions from "../references/_web3authcore-options.mdx";
